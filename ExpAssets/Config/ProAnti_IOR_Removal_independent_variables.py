...
ProAnti_IOR_Removal_ind_vars.add_variable(name='targ_loc', d_type=str, values=['left', 'right'])
ProAnti_IOR_Removal_ind_vars.add_variable(name='targ_type', d_type=str, values=['cross', 'x'])
